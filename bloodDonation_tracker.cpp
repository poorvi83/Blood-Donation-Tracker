...
class Donor
{
    ...
    public:
        ...
        {
            cout<<endl<<"-------------------------DONATION DETAILS-------------------------------";
            cout<<endl<<"Name: "<<name<<endl<<"Blood Group: "<<bloodGroup<<endl<<"City: "<<city<<endl<<"Contact: "<<contact<<endl<<"last donation date: "<<lastDonation;
        }
...
int main()
{
    ...
    do
    {
        cout<<endl<<"-------------------------------------------------------------BLOOD DONATION MANAGEMENT SYSTEM----------------------------------------------------------------------";
        cout<<endl<<"1. Add donor\n2. Search donor\n3. Display all donors\n4. delete donor entry\n5. exit"<<endl;
        cout<<"enter choice";
        cin>>choice;
